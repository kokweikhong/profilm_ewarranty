...
import { productAllocationColumns } from "@/lib/tableColumns";
...
export default function Page() {
  ...
  console.log("Product Allocations:", productAllocations);
  return (
    <div>
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          ...
          <p className="mt-2 text-sm text-gray-700">
            ...
            their brand, type, series, name, warranty, film serial number, film
            quantity, and shipment number.
          </p>
        </div>
