...
import { ShopColumns } from "@/components/TableColumns";
    ...
    <div className="px-4 sm:px-6 lg:px-8">
      ...
      <div className="mt-6 grid grid-cols-1 gap-5 sm:grid-cols-3">
        ...
        <div className="overflow-hidden rounded-lg bg-white px-4 py-5 shadow border border-gray-200">
          <div className="flex items-center">
            <div className="shrink-0">
              <div className="rounded-md bg-gray-500/10 p-3">
                <svg
      ...
      <div className="mt-6">
        <div className="relative">
          ...
          <DebounceInput
            type="text"
            placeholder="Search shops by name, branch code, contact..."
