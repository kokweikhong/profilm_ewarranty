...
export default function ShopForm({ msiaStates, shop }: Props) {
  ...
  const { register, handleSubmit, formState } = useForm<CreateShopRequest>({
    defaultValues: shop
      ? {
          ...
          loginUsername: shop.loginUsername,
          loginPassword: "", // Password is not pre-filled for security reasons
        }
      : undefined,
  });
  ...
  const handleCompanyLicenseImageChange = (
    ...
    if (file) {
      ...
      reader.onloadend = () => {
        setCompanyLicenseImagePreview(reader.result as string);
      };
  ...
  const onSubmit: SubmitHandler<CreateShopRequest> = (data) => {
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              ...
              <div className="mt-2 flex items-center gap-x-6">
                ...
                <div className="flex-1">
                  ...
                  {companyLicenseImagePreview && (
                    <button
                      type="button"
                      onClick={() => setCompanyLicenseImagePreview(null)}
            ...
            <div className="col-span-full">
              ...
              <div className="mt-2 grid grid-cols-1">
                <select
                  id="shopState"
                  {...register("msiaStateId", { required: true })}
                >
