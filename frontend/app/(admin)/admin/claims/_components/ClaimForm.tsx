              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    readOnly={!isEditMode}
                    disabled
                    className="block w-full rounded-lg border border-gray-300  px-3 py-2 text-sm sm:text-base text-gray-900  placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-colors bg-gray-50 cursor-not-allowed"
                    placeholder={
                      isGeneratingClaimNo
                        ? "Generating..."
                        : isEditMode
